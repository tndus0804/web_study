...
public class BoardServiceImpl implements BoardService {
	...
	public BoardDTO getBoard(Integer boardNum) {
		...
		BoardDTO boardDTO = convertDTO(entity);		
	 ...
	 * @param uploadPath 첨부파일이 존재하는 디렉토리
...
//		log.debug("[board-delete-service] id: {}", boardNum);
	 ...
	 * @throws EntityNotFouncException
	 */
	@Override
	 ...
	 */
	@Override
	public void replyDelete(int replyNum, AuthenticatedUser user) throws Exception{
		...
		log.debug("[board-download-service] 리플 객체 : {}", replyEntity);
...
//				entityPage = boardRepository.findByMember_MemberId(searchWord, pageable);
		...
		Page<BoardDTO> boardDTOPage = new PageImpl<>(boardDTOList, entityPage.getPageable(), entityPage.getTotalElements());
