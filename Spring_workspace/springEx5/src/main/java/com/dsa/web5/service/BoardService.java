...
public interface BoardService {
	...
	void setLike(int boardNum);

	void update(BoardDTO boardDTO, String username, String uploadPath, MultipartFile upload) throws Exception;

	void delete(int boardNum, String uploadPath, String username) throws Exception;

	void replyWrite(ReplyDTO replyDTO);

	void replyDelete(int replyNum, AuthenticatedUser user) throws Exception;
